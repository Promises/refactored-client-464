package com.jagex.runescape;/* Class75 - Decompiled by JODE
...
public class Signlink implements Runnable {
	...
	public EventQueue anEventQueue1533;
	public int anInt1542;
	public Interface1 anInterface1_1536;
	public Thread aThread1532;

	public Signlink(boolean active, Applet applet, int arg2, String arg3, int arg4) {
		aClass39_1527 = null;
		aClass22_1530 = null;
		aClass22_1535 = null;
		anInt1542 = 0;
		...
		try {
			...
			if (aString1534 == null)
				aString1534 = "~/";
			try {
				anEventQueue1533 = Toolkit.getDefaultToolkit()
						.getSystemEventQueue();
			...
			if (active)
				findCacheDirectory(arg2, arg3, -47, arg4);
			aBoolean1543 = false;
	...
	public Interface1 method1177(int arg0) {
		try {
			if (arg0 > -112)
				aBoolean1543 = false;
			return anInterface1_1536;
		} catch (RuntimeException runtimeexception) {
			throw runtimeexception;
		}
	}
	...
	public void findCacheDirectory(int fileVersion, String arg1, int arg2, int arg3) {
		if ((fileVersion ^ 0xffffffff) > -33 || fileVersion > 34)
			fileVersion = 32;
		String[] strings = { getUserCache() };
		String[] strings_0_ = { "" };
		boolean bool = false;
		for (int i = 0; i < 2; i++) {
			for (int i_1_ = 0; (strings_0_.length ^ 0xffffffff) < (i_1_ ^ 0xffffffff); i_1_++) {
				for (int i_2_ = 0; (strings.length ^ 0xffffffff) < (i_2_ ^ 0xffffffff); i_2_++) {
					try {
						String string = strings[i_2_];
						if (string.length() > 0 && !new File(string).exists())
							continue;
						File file = new File(string + strings_0_[i_1_]);
						if (i == 1 && !file.exists()) {

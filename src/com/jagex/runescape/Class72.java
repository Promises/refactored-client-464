		...
		try {
			...
			if (Class49.aBoolean990)
				...
				if ((Class54.anInt1109 ^ 0xffffffff) == -1
					...
					arg0.method571(Class34.aJagexString_1762, 382, -i + 276,
							16777215, -1);
				}
				if ((Class54.anInt1109 ^ 0xffffffff) == -21) {
					...
					arg0.method571(Class34.aJagexString_1771, 382, i, 16776960, 0);
					i += 15;
					arg0.method571(Class34.aJagexString_1766, 382, i, 16776960, 0);
					i += 15;
					arg0.method571(Class34.aJagexString_1769, 382, i, 16776960, 0);
					i += 15;
					i += 10;
					arg0.method577(
				...
				if ((Class54.anInt1109 ^ 0xffffffff) == -11) {
					...
					if (Class4_Sub20_Sub14.anInt3140 == 0) {
						...
						Class4_Sub20_Sub7_Sub1.aClass4_Sub20_Sub12_Sub1_3260
								.method507(-73 + i_1_, i_2_ + -20);
						arg0.method566(AppletListener.aJagexString_1463, i_1_ + -73, i_2_
								+ -20, 144, 40, 16777215, 0, 1, 1, 0);
					} else if (Class4_Sub20_Sub14.anInt3140 == 2) {
						int i = 211;
						arg0.method571(Class34.aJagexString_1771, 382, i, 16776960,
								0);
						int i_3_ = 302;
						i += 15;
						int i_4_ = 321;
						arg0.method571(Class34.aJagexString_1766, 382, i, 16776960,
								0);
						i += 15;
						arg0.method571(Class34.aJagexString_1769, 382, i, 16776960,
								0);
						i += 15;
						i += 10;
						arg0.method577(
						...
						int i = 382;
						arg0.method571(Class31.aJagexString_675, 382, 211,
								16776960, 0);
						int i_5_ = 236;

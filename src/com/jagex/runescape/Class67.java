...
public class Class67 {
    ...
    public static void method1086(boolean arg0, byte arg1) {
        try {
            ...
            throw JagexException.create(runtimeexception, ("tb.E("
                    + arg0 + ',' + arg1 + ')'));
        }
    }
        ...
        try {
            for (int i = 0; (i ^ 0xffffffff) > (SceneGraph.anInt2493 ^ 0xffffffff); i++) {
                if (Class77.anIntArray1585[i] + Class24.anIntArray568[i] > arg1
                        ...
                        && arg4 < (Class42.anIntArray852[i] + Actor.anIntArray3268[i])
    ...
    public static boolean method1089(int arg0, int arg1, byte arg2, byte[] arg3) {
        try {
            ...
            throw JagexException.create(runtimeexception, ("tb.B("
                    + arg0 + ',' + arg1 + ',' + arg2 + ','
                    + (arg3 != null ? "{...}" : "null") + ')'));
        }
    }

    public static int getFloorDrawHeight(int x, int y, int plane) {
        int groundX = x >> 7;
        int groundY = y >> 7;
        ...
        int groundZ = plane;
        if (groundZ < 3 && (Class46.currentSceneTileFlags[1][groundX][groundY] & 2) == 2) {
            groundZ++;
        }
        int _x = x & 0x7f;
        int _y = y & 0x7f ;
        int i2 = Class4_Sub23.intGroundArray[groundZ][groundX][groundY] * (128 - _x) + Class4_Sub23.intGroundArray[groundZ][groundX + 1][groundY] * _x >> 7;
        int j2 = Class4_Sub23.intGroundArray[groundZ][groundX][groundY + 1] * (128 - _x) + Class4_Sub23.intGroundArray[groundZ][groundX + 1][groundY + 1] * _x >> 7;
    ...
    public static void method1091(int arg0) {
        try {
            ...
            throw JagexException.create(runtimeexception, "tb.A("
                    + arg0 + ')');
        }
    }

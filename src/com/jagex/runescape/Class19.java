...
public abstract class Class19 {
	...
	public static void method735(boolean arg0, JagexString arg1, byte arg2) {
		try {
			...
			throw JagexException.create(runtimeexception, ("ef.HA("
					+ arg0 + ',' + (arg1 != null ? "{...}" : "null") + ','
					+ arg2 + ')'));
		}
	}
	...
	public static boolean method750(boolean arg0, int arg1) {
		try {
			...
			throw JagexException.create(runtimeexception, ("ef.BA("
					+ arg0 + ',' + arg1 + ')'));
		}
	}
	...
	public static void method757(byte arg0) {
		try {
			...
			throw JagexException.create(runtimeexception, "ef.W("
					+ arg0 + ')');
		}
	}
	...
	public void method736(int arg0) {
		try {
			...
			throw JagexException.create(runtimeexception, "ef.NA("
					+ arg0 + ')');
		}
	}
	...
	public boolean method737(int arg0, byte arg1, int[] arg2) {
		try {
			...
			throw JagexException.create(runtimeexception, ("ef.CA("
					+ arg0 + ',' + arg1 + ','
					+ (arg2 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public byte[] method738(int arg0, byte arg1, int arg2) {
		try {
			...
			throw JagexException.create(runtimeexception, ("ef.Q("
					+ arg0 + ',' + arg1 + ',' + arg2 + ')'));
		}
	}
	...
	public boolean method739(byte arg0, int arg1, int arg2) {
		try {
			...
			throw JagexException.create(runtimeexception, ("ef.O("
					+ arg0 + ',' + arg1 + ',' + arg2 + ')'));
		}
	}
	...
	public byte[] method740(int arg0, boolean arg1) {
		try {
			...
			throw JagexException.create(runtimeexception, ("ef.KA("
					+ arg0 + ',' + arg1 + ')'));
		}
	}
	...
	public int method741(int arg0, boolean arg1) {
		try {
			...
			throw JagexException.create(runtimeexception, ("ef.AA("
					+ arg0 + ',' + arg1 + ')'));
		}
	}
	...
	public boolean method742(int arg0, int arg1) {
		try {
			...
			throw JagexException.create(runtimeexception, ("ef.MA("
					+ arg0 + ',' + arg1 + ')'));
		}
	}
	...
	public boolean method744(byte arg0, JagexString arg1, JagexString arg2) {
		try {
			...
			throw JagexException.create(runtimeexception, ("ef.DA("
					+ arg0 + ',' + (arg1 != null ? "{...}" : "null") + ','
					+ (arg2 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public void method745(int arg0, JagexString arg1) {
		try {
			...
			throw JagexException.create(runtimeexception, ("ef.FA("
					+ arg0 + ',' + (arg1 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public byte[] method746(int arg0, byte arg1, int arg2) {
		try {
			...
			throw JagexException.create(runtimeexception, ("ef.T("
					+ arg0 + ',' + arg1 + ',' + arg2 + ')'));
		}
	}
	...
	public int method747(boolean arg0, JagexString arg1, int arg2) {
		try {
			...
			throw JagexException.create(runtimeexception, ("ef.U("
					+ arg0 + ',' + (arg1 != null ? "{...}" : "null") + ','
					+ arg2 + ')'));
		}
	}
	...
	public void method748(int arg0, int arg1) {
		try {
			...
			throw JagexException.create(runtimeexception, ("ef.F("
					+ arg0 + ',' + arg1 + ')'));
		}
	}
	...
	public byte[] method749(boolean arg0, int arg1) {
		try {
			...
			throw JagexException.create(runtimeexception, ("ef.R("
					+ arg0 + ',' + arg1 + ')'));
		}
	}
	...
	public int[] method751(int arg0, int arg1) {
		try {
			...
			throw JagexException.create(runtimeexception, ("ef.V("
					+ arg0 + ',' + arg1 + ')'));
		}
	}
	...
	public boolean method752(byte arg0) {
		try {
			...
			throw JagexException.create(runtimeexception, "ef.S("
					+ arg0 + ')');
		}
	}
	...
	public byte[] method753(boolean arg0, JagexString arg1, JagexString arg2) {
		try {
			...
			throw JagexException.create(runtimeexception, ("ef.EA("
					+ arg0 + ',' + (arg1 != null ? "{...}" : "null") + ','
					+ (arg2 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public int method754(JagexString arg0, int arg1) {
		try {
			...
			throw JagexException.create(runtimeexception, ("ef.LA("
					+ (arg0 != null ? "{...}" : "null") + ',' + arg1 + ')'));
		}
	}
	...
	public void method755(int arg0, int arg1) {
		try {
			...
			throw JagexException.create(runtimeexception, ("ef.JA("
					+ arg0 + ',' + arg1 + ')'));
		}
	}
	...
	public void method756(byte arg0, byte[] arg1) {
		...
		if (i >= 6) {
			class4_sub11.readInt();
		}
		int i_25_ = class4_sub11.get();
		int i_26_ = -1;
		int i_27_ = 0;
		anInt526 = class4_sub11.readShort();
		anIntArray518 = new int[anInt526];
		for (int i_28_ = 0; i_28_ < anInt526; i_28_++) {
			anIntArray518[i_28_] = i_27_ += class4_sub11.readShort();
	...
	public byte[] method758(int[] arg0, int arg1, boolean arg2, int arg3) {
		try {
			...
			throw JagexException.create(runtimeexception, ("ef.GA("
					+ (arg0 != null ? "{...}" : "null") + ',' + arg1 + ','
					+ arg2 + ',' + arg3 + ')'));
		}
	}
	...
	public int method759(int arg0) {
		try {
			...
			throw JagexException.create(runtimeexception, "ef.P("
					+ arg0 + ')');
		}
	}
}

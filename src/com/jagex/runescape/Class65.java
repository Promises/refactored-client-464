...
public class Class65 {
	...
	public static void method1073(boolean arg0) {
		try {
			...
			throw JagexException.create(runtimeexception, "se.A("
					+ arg0 + ')');
		}
	}
	...
	public static JagexString method1076(JagexString arg0, RSInterface arg1,
		...
		try {
			...
			throw JagexException.create(runtimeexception, ("se.B("
					+ (arg0 != null ? "{...}" : "null") + ','
					+ (arg1 != null ? "{...}" : "null") + ',' + arg2 + ')'));
		}
	}
	...
	public RSFont method1067(boolean arg0) {
		try {
			...
			throw JagexException.create(runtimeexception, "se.E("
					+ arg0 + ')');
		}
	}
	...
	public void method1068(RSFont arg0, byte arg1) {
		try {
			...
			throw JagexException.create(runtimeexception, ("se.D("
					+ (arg0 != null ? "{...}" : "null") + ',' + arg1 + ')'));
		}
	}
	...
	public RSFont method1069(int arg0) {
		try {
			...
			throw JagexException.create(runtimeexception, "se.G("
					+ arg0 + ')');
		}
	}
	...
	public void method1070(byte arg0) {
		try {
			...
			throw JagexException.create(runtimeexception, "se.C("
					+ arg0 + ')');
		}
	}
	...
	public RSFont method1071(int arg0) {
		try {
			...
			throw JagexException.create(runtimeexception, "se.F("
					+ arg0 + ')');
		}
	}
	...
	public RSFont method1072(int arg0) {
		try {
			...
			throw JagexException.create(runtimeexception, "se.J("
					+ arg0 + ')');
		}
	}
	...
	public void method1074(RSFont arg0, byte arg1, RSFont arg2) {
		try {
			...
			throw JagexException.create(runtimeexception, ("se.I("
					+ (arg0 != null ? "{...}" : "null") + ',' + arg1 + ','
					+ (arg2 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public RSFont method1075(int arg0) {
		try {
			...
			throw JagexException.create(runtimeexception, "se.K("
					+ arg0 + ')');
		}
	}
	...
	public void method1077(boolean arg0, RSFont arg1) {
		try {
			...
			throw JagexException.create(runtimeexception, ("se.H("
					+ arg0 + ',' + (arg1 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public RSFont method1078(int arg0) {
		try {
			...
			throw JagexException.create(runtimeexception, "se.L("
					+ arg0 + ')');
		}
	}
}

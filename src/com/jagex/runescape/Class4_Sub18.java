...
public class Class4_Sub18 extends RSFont {
	...
	public Class4_Sub18(Buffer arg0) {
		arg0.currentPosition = arg0.byteBuffer.length - 3;
		int i = arg0.get();
		int i_15_ = arg0.readShort();
		int i_16_ = 14 + i * 10;
		arg0.currentPosition = 0;
		int i_17_ = 0;
		int i_18_ = 0;
		int i_19_ = 0;
		int i_20_ = 0;
		...
		i_16_ += i_22_ + i_24_;
		int i_28_ = arg0.currentPosition;
		int i_29_ = (i + i_17_ + i_18_ + i_19_ + i_20_ + i_21_ + i_22_ + i_23_ + i_24_);
		for (int i_30_ = 0; i_30_ < i_29_; i_30_++)
			arg0.method228(0);
		i_16_ += arg0.currentPosition - i_28_;
		int i_31_ = arg0.currentPosition;
		int i_32_ = 0;
		int i_33_ = 0;
		int i_34_ = 0;
		int i_35_ = 0;
		...
		int i_46_ = 0;
		int i_47_ = arg0.currentPosition;
		arg0.currentPosition += i_42_;
		int i_48_ = arg0.currentPosition;
		arg0.currentPosition += i_23_;
		int i_49_ = arg0.currentPosition;
		arg0.currentPosition += i_22_;
		int i_50_ = arg0.currentPosition;
		arg0.currentPosition += i_21_;
		int i_51_ = arg0.currentPosition;
		arg0.currentPosition += i_32_;
		int i_52_ = arg0.currentPosition;
		arg0.currentPosition += i_34_;
		int i_53_ = arg0.currentPosition;
		arg0.currentPosition += i_36_;
		int i_54_ = arg0.currentPosition;
		arg0.currentPosition += i_19_ + i_20_ + i_23_;
		int i_55_ = arg0.currentPosition;
		arg0.currentPosition += i_19_;
		int i_56_ = arg0.currentPosition;
		arg0.currentPosition += i_43_;
		int i_57_ = arg0.currentPosition;
		arg0.currentPosition += i_20_;
		int i_58_ = arg0.currentPosition;
		arg0.currentPosition += i_33_;
		int i_59_ = arg0.currentPosition;
		arg0.currentPosition += i_35_;
		int i_60_ = arg0.currentPosition;
		arg0.currentPosition += i_37_;
		int i_61_ = arg0.currentPosition;
		arg0.currentPosition += i_24_;
		int i_62_ = arg0.currentPosition;
		arg0.currentPosition += i_21_;
		int i_63_ = arg0.currentPosition;
		arg0.currentPosition += i_38_;
		int i_64_ = arg0.currentPosition;
		arg0.currentPosition += i_39_;
		int i_65_ = arg0.currentPosition;
		arg0.currentPosition += i_40_;
		int i_66_ = arg0.currentPosition;
		arg0.currentPosition += i_41_;
		int i_67_ = arg0.currentPosition;
		arg0.currentPosition += i_17_ * 3;
		...
		for (int i_75_ = 0; i_75_ < i; i_75_++) {
			...
			class4_sub11.currentPosition += 4;
			int i_76_ = class4_sub11.currentPosition;
			int i_77_ = -1;
			while_2_: do {
				for (;;) {
			...
			class4_sub11.method249(class4_sub11.currentPosition - i_76_, -22334);
		}
	}

...
public class Class47 {
    ...
    public static void method976(byte arg0) {
		try {
			...
			throw JagexException.create(runtimeexception, "me.B("
					+ arg0 + ')');
		}
	}
	...
	public static void method977(int arg0) {
		try {
			...
			throw JagexException.create(runtimeexception, "me.D("
					+ arg0 + ')');
		}
	}
	...
	public static void method978(int arg0, int arg1, boolean arg2, int arg3,
		...
		try {
			...
			if (Class53.anInt1079 != arg0
				...
				int i_0_ = ItemDefinition.anInt2987;
				ItemDefinition.anInt2987 = (-6 + arg5) * 8;
				Class6.anInt217 = 8 * (-6 + arg0);
				int i_1_ = ItemDefinition.anInt2987 + -i_0_;
				i_0_ = ItemDefinition.anInt2987;
			...
			throw JagexException.create(runtimeexception, ("me.C("
	...
	public static void method981(int arg0) {
		try {
			...
			throw JagexException.create(runtimeexception, "me.F("
					+ arg0 + ')');
		}
	}
	...
	public static byte[] method982(int arg0, byte[] arg1) {
		try {
			...
			throw JagexException.create(runtimeexception, ("me.A("
					+ arg0 + ',' + (arg1 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public int method979(byte[] arg0, byte[] arg1, int arg2, int arg3,
		...
		try {
			...
			throw JagexException.create(runtimeexception, ("me.G("
					+ (arg0 != null ? "{...}" : "null") + ','
					+ (arg1 != null ? "{...}" : "null") + ',' + arg2 + ','
					+ arg3 + ',' + arg4 + ',' + arg5 + ')'));
		}
	...
	public int method980(byte[] arg0, int arg1, int arg2, byte[] arg3,
		...
		try {
			...
			throw JagexException.create(runtimeexception, ("me.E("
					+ (arg0 != null ? "{...}" : "null") + ',' + arg1 + ','
					+ arg2 + ',' + (arg3 != null ? "{...}" : "null") + ','
					+ arg4 + ',' + arg5 + ')'));
		}

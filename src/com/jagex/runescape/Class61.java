...
public class Class61 {
                ...
                if (Class54.anInt1109 == 30) {
                    ...
                    if (AppletListener.anInt1448 > 750) {
                        ...
                        if ((Class38.anInt770 ^ 0xffffffff) < -501) {
                            ...
                            if ((0x4 & i_25_) == 4) {
                                Class4_Sub16.cameraRandomisationA += Class4_Sub20_Sub4.anInt2858;
                            }
                            if ((0x1 & i_25_) == 1) {
                        ...
                        if ((Class4_Sub16.cameraRandomisationA ^ 0xffffffff) > 39) {
                        ...
                        if ((Class4_Sub16.cameraRandomisationA ^ 0xffffffff) < -41) {
                            Class4_Sub20_Sub4.anInt2858 = -1;
                        }
    ...
    public static void method1045(boolean arg0, int arg1, int arg2, int arg3,
        ...
        if (!Class25.cutsceneActive) {
            int vertical = Class1.cameraVerticalPosition;
            if (Class74.secondaryCameraVertical / 256 > vertical) {
                vertical = Class74.secondaryCameraVertical / 256;
            }
            int horizontal = Class4_Sub16.cameraRandomisationA + Class49.cameraHorizontalPosition & 0x7ff;
            if (RS2Font.customCameraActive[4] && 128 + SceneGraph.anIntArray2504[4] > vertical) {
                vertical = 128 + SceneGraph.anIntArray2504[4];
            }
            Class16.setCameraPosition(vertical, Class24.currentCameraPositionH,
                    Class67.getFloorDrawHeight((Class4_Sub15.localPlayer.worldX), (Class4_Sub15.localPlayer.worldY), Class82.plane) - 50,
                    600 + 3 * vertical, Class24.currentCameraPositionV, horizontal);
        }
        int i;
        if (!Class25.cutsceneActive) {
        ...
        for (int i_33_ = 0; i_33_ < 5; i_33_++) {
            if (RS2Font.customCameraActive[i_33_]) {

...
public class Class24 {
	...
	public static JagexString aJagexString_551 = JagexString.getRs2PreparedString(
			"Hidden)2");
	...
	public static JagexString aJagexString_563;
	public static JagexString aJagexString_564;
	public static JagexString aJagexString_565 = JagexString.getRs2PreparedString(":assistreq:");
	public static JagexString aJagexString_566 = JagexString.getRs2PreparedString("Choose Option");
	public static JagexString aJagexString_567 = JagexString.getRs2PreparedString("Drop");
	...
	static {
		aJagexString_563 = aJagexString_566;
		aJagexString_564 = aJagexString_567;
	}
	...
	public static void method787(boolean arg0) {
		try {
			...
			if ((Class4_Sub6.anInt1932 ^ 0xffffffff) != 0)
				Class4_Sub20_Sub7_Sub1_Sub1.method390(Class4_Sub6.anInt1932,
						-20339);
					...
					if (!Class4_Sub20_Sub7_Sub3.aBooleanArray3342[i]) {
						if (Class16.aBooleanArray452[i])
							Class4_Sub20_Sub12.method498(anIntArray568[i],
									...
									Class4_Sub20_Sub7_Sub1.anIntArray3268[i],
									16711680, 128);
					} else
						Class4_Sub20_Sub12.method498(anIntArray568[i],
								Class42.anIntArray852[i],
			...
			Class19_Sub1.method764(Class82.anInt1711,
	...
	public static void method788(int arg0, int arg1, int arg2, int arg3,
		...
		if (Class28.anInt640 == 1)
			Class8.aClass4_Sub20_Sub12_Sub2Array253[Class11.anInt331 / 100]
					.method532(-8 + Class57.anInt1155, -8 + Class2.anInt96);
		anInt552++;
		if ((Class28.anInt640 ^ 0xffffffff) == -3)
			Class8.aClass4_Sub20_Sub12_Sub2Array253[Class11.anInt331 / 100 + 4]
					.method532(Class57.anInt1155 + -8, -8 + Class2.anInt96);
		if (arg2 == 20) {
				...
				Class4_Sub15.aClass4_Sub20_Sub12_Sub4_Sub1_2289.method557(
						Class4_Sub24.method639(
								(new JagexString[] { Class45.aJagexString_918,
										...
										Class18.aJagexString_472}), -842), i,
						i_0_, i_1_, -1);
				i_0_ += 15;
			}
		}
	...
	public static void method789(byte arg0) {
		anInt553++;
		if (Class4_Sub17.aBooleanArray2320[98])
			Class4_Sub20_Sub13.anInt3112 += (12 - Class4_Sub20_Sub13.anInt3112) / 2;
		else if (Class4_Sub17.aBooleanArray2320[99])
			Class4_Sub20_Sub13.anInt3112 += (-Class4_Sub20_Sub13.anInt3112 + -12) / 2;
		else
			Class4_Sub20_Sub13.anInt3112 /= 2;
		if (!Class4_Sub17.aBooleanArray2320[96]) {
			if (!Class4_Sub17.aBooleanArray2320[97])
				Class78.anInt1604 /= 2;
			else
				Class78.anInt1604 += (-Class78.anInt1604 + 24) / 2;
		} else
			Class78.anInt1604 += (-24 + -Class78.anInt1604) / 2;
		int i = (Class4_Sub15.aClass4_Sub20_Sub7_Sub1_Sub1_2302.anInt3267 - -Class4_Sub20_Sub7_Sub3.anInt3354);
		Class1.anInt70 += Class4_Sub20_Sub13.anInt3112 / 2;
		if ((Class1.anInt70 ^ 0xffffffff) > -129)
			Class1.anInt70 = 128;
		Class49.anInt999 = Class49.anInt999 - -(Class78.anInt1604 / 2) & 0x7ff;
		if (arg0 <= 77)
			aJagexString_563 = null;
		int i_3_ = (Class4_Sub15.aClass4_Sub20_Sub7_Sub1_Sub1_2302.anInt3270 - -Class4_Sub23.anInt2412);
		if (Class4_Sub20_Sub7_Sub1_Sub2.anInt3621 - i_3_ < -500
				|| ((Class4_Sub20_Sub7_Sub1_Sub2.anInt3621 + -i_3_ ^ 0xffffffff) < -501)
				|| RSCanvas.anInt57 - i < -500 || -i + RSCanvas.anInt57 > 500) {
			Class4_Sub20_Sub7_Sub1_Sub2.anInt3621 = i_3_;
			RSCanvas.anInt57 = i;
		}
		if (i != RSCanvas.anInt57)
			RSCanvas.anInt57 += (i + -RSCanvas.anInt57) / 16;
		if ((i_3_ ^ 0xffffffff) != (Class4_Sub20_Sub7_Sub1_Sub2.anInt3621 ^ 0xffffffff))
			Class4_Sub20_Sub7_Sub1_Sub2.anInt3621 += (-Class4_Sub20_Sub7_Sub1_Sub2.anInt3621 + i_3_) / 16;
		if (Class1.anInt70 > 383)
			Class1.anInt70 = 383;
		int i_4_ = 0;
		int i_5_ = RSCanvas.anInt57 >> -1631692377;
		int i_6_ = Class4_Sub20_Sub7_Sub1_Sub2.anInt3621 >> -113629593;
		int i_7_ = Class67.method1090(Class4_Sub20_Sub7_Sub1_Sub2.anInt3621,
				RSCanvas.anInt57, true, Class82.anInt1711);
		if (i_6_ > 3 && (i_5_ ^ 0xffffffff) < -4 && (i_6_ ^ 0xffffffff) > -101
				&& (i_5_ ^ 0xffffffff) > -101) {
			for (int i_8_ = i_6_ + -4; (4 + i_6_ ^ 0xffffffff) <= (i_8_ ^ 0xffffffff); i_8_++) {
				for (int i_9_ = i_5_ + -4; i_5_ + 4 >= i_9_; i_9_++) {
					int i_10_ = Class82.anInt1711;
					if ((i_10_ ^ 0xffffffff) > -4
							&& ((0x2 & Class46.landscapeData[1][i_8_][i_9_]) == 2))
						i_10_++;
					int i_11_ = i_7_
							+ -(Class4_Sub23.anIntArrayArrayArray2416[i_10_][i_8_][i_9_]);
		...
		if (i_12_ < 32768)
			i_12_ = 32768;
		if (i_12_ > Class74.anInt1514)
			Class74.anInt1514 += (-Class74.anInt1514 + i_12_) / 24;
		else if ((Class74.anInt1514 ^ 0xffffffff) < (i_12_ ^ 0xffffffff))
			Class74.anInt1514 += (i_12_ - Class74.anInt1514) / 80;
	}
	...
	public static void method791(int arg0, int arg1, int arg2, boolean arg3) {
		try {
			if (arg1 == 18834) {
				...
				Class4_Sub20_Sub7_Sub1.aBoolean3218 = arg3;
	...
	public static void method793(int arg0) {
		try {
			aJagexString_551 = null;
			aJagexString_565 = null;
			aJagexString_558 = null;
			aClass19_Sub1_562 = null;
			aJagexString_567 = null;
			aClass27Array550 = null;
			if (arg0 != 8421)
				aJagexString_567 = null;
			aJagexString_563 = null;
			anIntArray568 = null;
			aJagexString_564 = null;
			aClass4_Sub20_Sub12_Sub1_549 = null;
			anIntArray557 = null;
			aJagexString_566 = null;
			aJagexString_560 = null;
		} catch (RuntimeException runtimeexception) {
	...
	public static void method794(int arg0, Class4_Sub20_Sub7_Sub1 arg1, int arg2) {
		Class63.method1053(arg1.anInt3270, false, arg0, arg1.anInt3267);
		anInt561++;
		if (arg2 >= -125)

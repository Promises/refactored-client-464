...
public class Class4_Sub9 extends RSFont {
	...
	public void method192(byte[] arg0) {
		...
		anInt1990 = class4_sub11.readInt((byte) 73);
		anInt2011 = class4_sub11.readInt((byte) 73);
		anInt2007 = class4_sub11.readInt((byte) 73);
		anInt1998 = class4_sub11.readInt((byte) 73);
		if (anInt1998 < 0) {
			anInt1998 = anInt1998 ^ 0xffffffff;
			aBoolean1985 = true;
		}
		int i = class4_sub11.readInt((byte) 73);

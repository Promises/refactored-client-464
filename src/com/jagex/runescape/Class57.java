...
public class Class57 {
	...
	public static int method1020(int arg0, int arg1, int arg2, int arg3) {
		try {
			...
			throw JagexException.create(runtimeexception, ("q.B("
					+ arg0 + ',' + arg1 + ',' + arg2 + ',' + arg3 + ')'));
		}
	}
	...
	public static void method1021(int arg0) {
		try {
			...
			throw JagexException.create(runtimeexception, "q.C("
					+ arg0 + ')');
		}
	}
	...
	public static void method1022(byte arg0) {
		try {
			...
			throw JagexException.create(runtimeexception, "q.H("
					+ arg0 + ')');
		}
	}
	...
	public static void method1023(int arg0) {
		try {
			...
			throw JagexException.create(runtimeexception, "q.G("
					+ arg0 + ')');
		}
	}
	...
	public static ImageRGB method1024(int arg0, Class19 arg1,
		...
		try {
			...
			throw JagexException.create(runtimeexception, ("q.A("
					+ arg0 + ',' + (arg1 != null ? "{...}" : "null") + ','
					+ (arg2 != null ? "{...}" : "null") + ','
					+ (arg3 != null ? "{...}" : "null") + ')'));
		}
	...
	public static Class4_Sub20_Sub12_Sub4_Sub1 method1026(JagexString arg0,
		...
		try {
			...
			throw JagexException.create(runtimeexception, ("q.I("
					+ (arg0 != null ? "{...}" : "null") + ','
					+ (arg1 != null ? "{...}" : "null") + ',' + arg2 + ','
					+ (arg3 != null ? "{...}" : "null") + ','
					+ (arg4 != null ? "{...}" : "null") + ')'));
	...
	public static void method1027(int arg0) {
		try {
			...
			throw JagexException.create(runtimeexception, "q.E("
					+ arg0 + ')');
		}
	}
	...
	public static int method1028(int arg0, int arg1) {
		try {
			...
			throw JagexException.create(runtimeexception, ("q.D("
					+ arg0 + ',' + arg1 + ')'));
		}
	}

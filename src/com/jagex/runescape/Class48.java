...
public class Class48 {
	...
	public static void method983(int arg0, int arg1, int arg2) {
		try {
			...
			Class4_Sub20_Sub15.method601(Class65.anIntArray1289, arg0 + 18084,
					-1 + (Class4_Sub20_Sub7_Sub1_Sub1.aClass9Array3579).length,
	...
	public static int method987(byte arg0) {
		try {
			anInt982++;
			int i_2_ = Class67.method1090(Class6.anInt209, Class33.anInt708,
					true, Class82.anInt1711);
			if (i_2_ - RSInterface.anInt2176 < 800
					&& (0x4 & (Class46.landscapeData[Class82.anInt1711][Class6.anInt209 >> -823825785][Class33.anInt708 >> 7612519]) ^ 0xffffffff) != -1)
				return Class82.anInt1711;
			return 3;
		} catch (RuntimeException runtimeexception) {
			throw Class4_Sub20_Sub7_Sub4.method423(runtimeexception, "mf.D("
					+ arg0 + ')');
		}
	}
}

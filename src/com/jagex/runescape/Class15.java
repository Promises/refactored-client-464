...
public class Class15 {
	public static boolean[] aBooleanArray421;
	public static float[] aFloatArray425 = { 1.0649863E-7F, 1.1341951E-7F,
	...
	public static int[] anIntArray414 = { 256, 128, 86, 64 };
	public static int[] anIntArray415;
	public static int[] anIntArray422;

	public static int method710(int[] arg0, int arg1) {
		int i = arg0[arg1];
		int i_0_ = -1;
		int i_1_ = 2147483647;
		for (int i_2_ = 0; i_2_ < arg1; i_2_++) {
			int i_3_ = arg0[i_2_];
			if (i_3_ > i && i_3_ < i_1_) {
				i_0_ = i_2_;
				i_1_ = i_3_;
	...
	public static int method713(int[] arg0, int arg1) {
		...
		for (int i_22_ = 0; i_22_ < arg1; i_22_++) {
			int i_23_ = arg0[i_22_];
			if (i_23_ < i && i_23_ > i_21_) {
				i_20_ = i_22_;
				i_21_ = i_23_;
			}
		}
	...
	public int[][] anIntArrayArray419;

	public Class15() {
		int i = Class4_Sub9.method198(16);
		if (i != 1)
			throw new RuntimeException();
		int i_43_ = Class4_Sub9.method198(5);
		int i_44_ = 0;
		anIntArray416 = new int[i_43_];
		for (int i_45_ = 0; i_45_ < i_43_; i_45_++) {
			int i_46_ = Class4_Sub9.method198(4);
			anIntArray416[i_45_] = i_46_;
			if (i_46_ >= i_44_)
				i_44_ = i_46_ + 1;
		}
		anIntArray418 = new int[i_44_];
		anIntArray417 = new int[i_44_];
		anIntArray420 = new int[i_44_];
		anIntArrayArray419 = new int[i_44_][];
		for (int i_47_ = 0; i_47_ < i_44_; i_47_++) {
			anIntArray418[i_47_] = Class4_Sub9.method198(3) + 1;
			int i_48_ = anIntArray417[i_47_] = Class4_Sub9.method198(2);
			if (i_48_ != 0)
				anIntArray420[i_47_] = Class4_Sub9.method198(8);
			i_48_ = 1 << i_48_;
			int[] is = new int[i_48_];
			anIntArrayArray419[i_47_] = is;
			for (int i_49_ = 0; i_49_ < i_48_; i_49_++)
				is[i_49_] = Class4_Sub9.method198(8) - 1;
		}
		anInt424 = Class4_Sub9.method198(2) + 1;
		int i_50_ = Class4_Sub9.method198(4);
		int i_51_ = 2;
		for (int i_52_ = 0; i_52_ < i_43_; i_52_++)
			i_51_ += anIntArray418[anIntArray416[i_52_]];
		anIntArray423 = new int[i_51_];
		anIntArray423[0] = 0;
		anIntArray423[1] = 1 << i_50_;
		i_51_ = 2;
		for (int i_53_ = 0; i_53_ < i_43_; i_53_++) {
			int i_54_ = anIntArray416[i_53_];
			for (int i_55_ = 0; i_55_ < anIntArray418[i_54_]; i_55_++)
				anIntArray423[i_51_++] = Class4_Sub9.method198(i_50_);
		}
		if (anIntArray422 == null || anIntArray422.length < i_51_) {
			anIntArray422 = new int[i_51_];
			anIntArray415 = new int[i_51_];
			aBooleanArray421 = new boolean[i_51_];
		}
	}
	...
	public void method711(int arg0, int arg1) {
		if (arg0 < arg1) {
			int i = arg0;
			int i_4_ = anIntArray422[i];
			int i_5_ = anIntArray415[i];
			boolean bool = aBooleanArray421[i];
			for (int i_6_ = arg0 + 1; i_6_ <= arg1; i_6_++) {
				int i_7_ = anIntArray422[i_6_];
				if (i_7_ < i_4_) {
					anIntArray422[i] = i_7_;
					anIntArray415[i] = anIntArray415[i_6_];
					aBooleanArray421[i] = aBooleanArray421[i_6_];
					i++;
					anIntArray422[i_6_] = anIntArray422[i];
					anIntArray415[i_6_] = anIntArray415[i];
					aBooleanArray421[i_6_] = aBooleanArray421[i];
				}
			}
			anIntArray422[i] = i_4_;
			anIntArray415[i] = i_5_;
			aBooleanArray421[i] = bool;
			method711(arg0, i - 1);
			method711(i + 1, arg1);
		}
	}
	...
	public boolean method712() {
		...
		if (!bool)
			return false;
		int i = anIntArray423.length;
		for (int i_8_ = 0; i_8_ < i; i_8_++)
			anIntArray422[i_8_] = anIntArray423[i_8_];
		int i_9_ = anIntArray414[anInt424 - 1];
		int i_10_ = Class68.method1096(i_9_ - 1, -121);
		anIntArray415[0] = Class4_Sub9.method198(i_10_);
		anIntArray415[1] = Class4_Sub9.method198(i_10_);
		int i_11_ = 2;
		for (int i_12_ = 0; i_12_ < anIntArray416.length; i_12_++) {
			int i_13_ = anIntArray416[i_12_];
			int i_14_ = anIntArray418[i_13_];
			int i_15_ = anIntArray417[i_13_];
			int i_16_ = (1 << i_15_) - 1;
			int i_17_ = 0;
			if (i_15_ > 0)
				i_17_ = Class4_Sub9.aClass60Array2006[anIntArray420[i_13_]]
						.method1040();
			for (int i_18_ = 0; i_18_ < i_14_; i_18_++) {
				int i_19_ = anIntArrayArray419[i_13_][i_17_ & i_16_];
				i_17_ >>>= i_15_;
				anIntArray415[i_11_++] = (i_19_ >= 0 ? Class4_Sub9.aClass60Array2006[i_19_]
						.method1040() : 0);
			}
		}
		return true;
	...
	public int method714(int arg0, int arg1, int arg2, int arg3, int arg4) {
		int i = arg3 - arg1;
		int i_24_ = arg2 - arg0;
		int i_25_ = i < 0 ? -i : i;
		int i_26_ = i_25_ * (arg4 - arg0);
	...
	public void method715(float[] arg0, int arg1) {
		int i = anIntArray423.length;
		int i_28_ = anIntArray414[anInt424 - 1];
		aBooleanArray421[0] = aBooleanArray421[1] = true;
		for (int i_29_ = 2; i_29_ < i; i_29_++) {
			int i_30_ = method713(anIntArray422, i_29_);
			int i_31_ = method710(anIntArray422, i_29_);
			int i_32_ = method714(anIntArray422[i_30_], anIntArray415[i_30_],
					anIntArray422[i_31_], anIntArray415[i_31_],
					anIntArray422[i_29_]);
			int i_33_ = anIntArray415[i_29_];
			int i_34_ = i_28_ - i_32_;
			int i_35_ = i_32_;
			int i_36_ = (i_34_ < i_35_ ? i_34_ : i_35_) << 1;
			if (i_33_ != 0) {
				aBooleanArray421[i_30_] = aBooleanArray421[i_31_] = true;
				aBooleanArray421[i_29_] = true;
				if (i_33_ >= i_36_)
					anIntArray415[i_29_] = (i_34_ > i_35_ ? i_33_ - i_35_
							+ i_32_ : i_32_ - i_33_ + i_34_ - 1);
				else
					anIntArray415[i_29_] = ((i_33_ & 0x1) != 0 ? i_32_
							- (i_33_ + 1) / 2 : i_32_ + i_33_ / 2);
			} else {
				aBooleanArray421[i_29_] = false;
				anIntArray415[i_29_] = i_32_;
			}
		}
		method711(0, i - 1);
		int i_37_ = 0;
		int i_38_ = anIntArray415[0] * anInt424;
		for (int i_39_ = 1; i_39_ < i; i_39_++) {
			if (aBooleanArray421[i_39_]) {
				int i_40_ = anIntArray422[i_39_];
				int i_41_ = anIntArray415[i_39_] * anInt424;
				method716(i_37_, i_38_, i_40_, i_41_, arg0, arg1);
				if (i_40_ >= arg1)
					return;
				i_37_ = i_40_;
				i_38_ = i_41_;
		...
		float f = aFloatArray425[i_38_];
		for (int i_42_ = i_37_; i_42_ < arg1; i_42_++)
			arg0[i_42_] *= f;
	}

	public void method716(int arg0, int arg1, int arg2, int arg3, float[] arg4,
			int arg5) {
		int i = arg3 - arg1;
		int i_56_ = arg2 - arg0;
		int i_57_ = i < 0 ? -i : i;
		...
		int i_59_ = arg1;
		int i_60_ = 0;
		int i_61_ = i < 0 ? i_58_ - 1 : i_58_ + 1;
		i_57_ = i_57_ - (i_58_ < 0 ? -i_58_ : i_58_) * i_56_;
		arg4[arg0] *= aFloatArray425[i_59_];
		if (arg2 > arg5)
			arg2 = arg5;
		for (int i_62_ = arg0 + 1; i_62_ < arg2; i_62_++) {
			i_60_ += i_57_;
			if (i_60_ >= i_56_) {
				i_60_ -= i_56_;
				i_59_ += i_61_;
				...
				i_59_ += i_58_;
			arg4[i_62_] *= aFloatArray425[i_59_];
		}
	}
}

...
public class Class4_Sub16 extends RSFont {
	...
	public static void method302(int arg0) {
		try {
			ItemDefinition.aClass66_3014.method1084(0);
			anInt2313++;
		} catch (RuntimeException runtimeexception) {
			throw JagexException.create(runtimeexception, "qa.B("
					+ arg0 + ')');
		}
	}
	...
	public static void method303(int arg0, Class19_Sub1 arg1, int arg2,
		...
		try {
			...
			throw JagexException.create(runtimeexception, ("qa.D("
					+ arg0 + ',' + (arg1 != null ? "{...}" : "null") + ','
					+ arg2 + ',' + (arg3 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public static JagexString method304(int arg0, boolean arg1) {
		try {
			...
			throw JagexException.create(runtimeexception, ("qa.C("
					+ arg0 + ',' + arg1 + ')'));
		}
	}
	...
	public static void method305(boolean arg0) {
		try {
			...
			throw JagexException.create(runtimeexception, "qa.A("
					+ arg0 + ')');
		}
	}

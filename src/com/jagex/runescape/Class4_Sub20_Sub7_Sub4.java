...
public class Class4_Sub20_Sub7_Sub4 extends Class4_Sub20_Sub7 {
	...
	public static void method420(int arg0) {
		try {
			...
			throw JagexException.create(runtimeexception, "gf.C(" + arg0 + ')');
		}
	}
	...
	public static ImageRGB method421(boolean arg0, int arg1,
		...
		try {
			...
			ItemDefinition itemDefinition = Class4_Sub23.method633(arg1,
					(byte) -115);
			if ((arg2 ^ 0xffffffff) < -2
					&& itemDefinition.stackIds != null) {
				int i = -1;
				for (int i_0_ = 0; i_0_ < 10; i_0_++) {
					if (arg2 >= itemDefinition.stackAmounts[i_0_]
							&& (itemDefinition.stackAmounts[i_0_] ^ 0xffffffff) != -1)
						i = itemDefinition.stackIds[i_0_];
				}
				if ((i ^ 0xffffffff) != 0)
					itemDefinition = Class4_Sub23.method633(i, (byte) -119);
			}
			Class4_Sub20_Sub7_Sub7 class4_sub20_sub7_sub7 = itemDefinition
					.method461(arg4 + 86, 1);
			...
			if ((itemDefinition.certTemplate ^ 0xffffffff) != 0) {
				imageRGB = method421(true,
						itemDefinition.certLink, 10, 1, (byte) -97, 0);
				if (imageRGB == null)
					return null;
			}
			...
			int i_4_ = itemDefinition.zoom2d;
			if (arg0)
				i_4_ = (int) (1.5 * i_4_);
			else if (arg3 == 2)
				i_4_ = (int) (1.04 * i_4_);
			int i_5_ = ((Class4_Sub20_Sub12_Sub3.SINE[itemDefinition.xan2d])
					* i_4_ >> -1882203568);
			int i_6_ = ((Class4_Sub20_Sub12_Sub3.COSINE[itemDefinition.xan2d])
					* i_4_ >> 1098861360);
			class4_sub20_sub7_sub7.method446();
			class4_sub20_sub7_sub7
					.method437(
							0,
							itemDefinition.yan2d,
							itemDefinition.zan2d,
							itemDefinition.xan2d,
							itemDefinition.xof2d,
							(itemDefinition.yof2d + (class4_sub20_sub7_sub7.anInt2938 / 2 + i_5_)),
							i_6_ + itemDefinition.yof2d);
			...
			if (!arg0
					&& ((itemDefinition.stackable ^ 0xffffffff) == -2 || arg2 != 1)
					&& arg2 != -1)
			...
			throw JagexException.create(runtimeexception, ("gf.B(" + arg0 + ',' + arg1
					+ ',' + arg2 + ',' + arg3 + ',' + arg4 + ',' + arg5 + ')'));
		}
	}
	...
	public static void method424(byte arg0, Object arg1, Signlink arg2) {
		do {
			try {
				...
				throw JagexException.create(runtimeexception, ("gf.A(" + arg0 + ','
						+ (arg1 != null ? "{...}" : "null") + ','
						+ (arg2 != null ? "{...}" : "null") + ')'));
			}
			break;
	...
	public Class4_Sub20_Sub7_Sub7 method378(boolean arg0) {
		try {
			...
			throw JagexException.create(runtimeexception, "gf.V(" + arg0 + ')');
		}
	}
}

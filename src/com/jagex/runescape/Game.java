...
//                }
                Class61.anInt1201 = Configuration.WORLD;
                if (!Configuration.DEPLOYMENT.equals("live")) {
                    if (!Configuration.DEPLOYMENT.equals("office")) {
                        if (!Configuration.DEPLOYMENT.equals("local")) {
                            Class4_Sub12.method279(1);
                        } else {
                            Class12.anInt341 = 2;
                        }
                ...
                if (!Configuration.GAMEVERSION.equals("live")) {
                    if (!Configuration.GAMEVERSION.equals("rc")) {
                        if (Configuration.GAMEVERSION.equals("wip")) {
                            Class48.anInt981 = 2;
                        } else {
                            Class4_Sub12.method279(1);
                        }
                ...
                if (!Configuration.HIGHMEN) {
                    Class63.method1054(true);
                } else {
                    Class71.method1157((byte) 124);
                }
                if (!Configuration.MEMBERS) {
                    Class77.members = true;
                } else {
                    Class77.members = false;
                }
                if (Configuration.LANGUAGE.equals("english")) {
                    Class19_Sub1.anInt2536 = 0;
                } else if (Configuration.LANGUAGE.equals("german")) {
                ...
                if (Configuration.GAME_TYPE.equals("game0")) {
                    Class4_Sub7.anInt1944 = 0;
                } else if (!Configuration.GAME_TYPE.equals("game1")) {
                    Class4_Sub12.method279(1);
                } else {
                ...
                Game game = new Game();
                game.initializeApplication(16, 765, 503, 464, "runescape", false,
                        Class48.anInt981 + 32);

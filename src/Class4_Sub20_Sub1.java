/* Class4_Sub20_Sub1 - Decompiled by JODE
...
public class Class4_Sub20_Sub1 extends Class4_Sub20 {
	...
	public static void method328(byte arg0, Class10 arg1, Class19_Sub1 arg2,
		...
		try {
			...
			throw Class4_Sub20_Sub7_Sub4.method423(runtimeexception, ("ab.L("
					+ arg0 + ',' + (arg1 != null ? "{...}" : "null") + ','
					+ (arg2 != null ? "{...}" : "null") + ',' + arg3 + ')'));
		}
	}
	...
	public static void method335(byte arg0) {
		try {
			...
			throw Class4_Sub20_Sub7_Sub4.method423(runtimeexception, "ab.B("
					+ arg0 + ')');
		}
	}
	...
	public Class4_Sub20_Sub7 method324(int arg0, int arg1, int arg2, int arg3,
		...
		try {
			...
			throw Class4_Sub20_Sub7_Sub4.method423(runtimeexception, ("ab.D("
	...
	public Class4_Sub20_Sub1 method325(int arg0) {
		try {
			...
			throw Class4_Sub20_Sub7_Sub4.method423(runtimeexception, "ab.G("
					+ arg0 + ')');
		}
	}
	...
	public Class4_Sub20_Sub7_Sub7 method326(int arg0, int arg1, int arg2,
		...
		try {
			...
			throw Class4_Sub20_Sub7_Sub4.method423(runtimeexception, ("ab.A("
					+ arg0 + ',' + arg1 + ',' + arg2 + ',' + arg3 + ',' + arg4
					+ ',' + arg5 + ',' + arg6 + ')'));
		}
	}
	...
	public boolean method329(int arg0, int arg1) {
		try {
			...
			throw Class4_Sub20_Sub7_Sub4.method423(runtimeexception, ("ab.K("
					+ arg0 + ',' + arg1 + ')'));
		}
	}
	...
	public boolean method330(byte arg0) {
		try {
			...
			throw Class4_Sub20_Sub7_Sub4.method423(runtimeexception, "ab.M("
					+ arg0 + ')');
		}
	}
	...
	public boolean method331(int arg0) {
		try {
			...
			throw Class4_Sub20_Sub7_Sub4.method423(runtimeexception, "ab.J("
					+ arg0 + ')');
		}
	}
	...
	public Class4_Sub20_Sub7_Sub7 method334(Class4_Sub20_Sub17 arg0, int arg1,
		...
		try {
			...
			throw Class4_Sub20_Sub7_Sub4.method423(runtimeexception, ("ab.F("
					+ (arg0 != null ? "{...}" : "null") + ',' + arg1 + ','
	...
	public Class4_Sub20_Sub7_Sub2 method336(byte arg0, int arg1, int arg2) {
		try {
			...
			throw Class4_Sub20_Sub7_Sub4.method423(runtimeexception, ("ab.I("
					+ arg0 + ',' + arg1 + ',' + arg2 + ')'));
		}
	}
}

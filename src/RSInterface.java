/* Class4_Sub13 - Decompiled by JODE
...
public class RSInterface extends RSFont {
	...
	public static Class4_Sub23 method285(int arg0, byte arg1, Class19 arg2) {
		try {
			...
			throw Class4_Sub20_Sub7_Sub4.method423(runtimeexception, ("nc.A("
					+ arg0 + ',' + arg1 + ','
					+ (arg2 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public static void method291(int arg0) {
		try {
			...
			throw Class4_Sub20_Sub7_Sub4.method423(runtimeexception, "nc.F("
					+ arg0 + ')');
		}
	}
	...
	public static int method293(int arg0, int arg1, int arg2, int arg3) {
		try {
			...
			throw Class4_Sub20_Sub7_Sub4.method423(runtimeexception, ("nc.I("
					+ arg0 + ',' + arg1 + ',' + arg2 + ',' + arg3 + ')'));
		}
	}
		...
		try {
			...
			if (class4_sub20_sub7_sub7 == null) {
				...
				if ((i_25_ ^ 0xffffffff) == -5) {
					...
					Class4_Sub20_Sub7_Sub2 class4_sub20_sub7_sub2 = class4_sub20_sub8
							.method474(10, 10);
					if (class4_sub20_sub7_sub2 == null) {
						Class4_Sub20_Sub13.aBoolean3116 = true;
						return null;
					...
					class4_sub20_sub7_sub7 = (class4_sub20_sub7_sub2.method411(
							64 + class4_sub20_sub8.anInt2970,
							class4_sub20_sub8.anInt2963 + 768, -50, -10, -50));
				}
			...
			throw Class4_Sub20_Sub7_Sub4.method423(runtimeexception, ("nc.K("
					+ arg0 + ',' + (arg1 != null ? "{...}" : "null") + ','
					+ (arg2 != null ? "{...}" : "null") + ',' + arg3 + ','
					+ arg4 + ')'));
		}
	...
	public void method283(int arg0, StreamBuffer arg1) {
		...
		if ((anInt2258 ^ 0xffffffff) == -3) {
			...
			for (int i_36_ = 0; (i_36_ ^ 0xffffffff) > -21; i_36_++) {
				...
				if (i_37_ == 1) {
					...
					anIntArray2177[i_36_] = arg1.method219((byte) 73);
				} else
		...
		if ((anInt2258 ^ 0xffffffff) == -2 || anInt2258 == 3
			...
			anInt2195 = arg1.method219((byte) 73);
		if (anInt2258 == 3 || (anInt2258 ^ 0xffffffff) == -5) {
			anInt2256 = arg1.method219((byte) 73);
			anInt2197 = arg1.method219((byte) 73);
			anInt2142 = arg1.method219((byte) 73);
		}
		if (anInt2258 == 5) {
			anInt2147 = arg1.method219((byte) 73);
			anInt2228 = arg1.method219((byte) 73);
		}
	...
	public int[] method284(boolean arg0, StreamBuffer arg1) {
		try {
			...
			for (int i_42_ = 0; i_42_ < i; i_42_++)
				is[i_42_] = arg1.method219((byte) 73);
			return is;
		} catch (RuntimeException runtimeexception) {
	...
	public void method287(StreamBuffer arg0, byte arg1) {
		try {
			...
			if (anInt2258 == 5) {
				...
				anInt2266 = arg0.get();
				anInt2201 = arg0.get();
				anInt2162 = arg0.method219((byte) 73);
			...
			throw Class4_Sub20_Sub7_Sub4.method423(runtimeexception, ("nc.C("
					+ (arg0 != null ? "{...}" : "null") + ',' + arg1 + ')'));
		}
	}
	...
	public Class4_Sub20_Sub12_Sub4_Sub1 method289(int arg0) {
		try {
			...
			throw Class4_Sub20_Sub7_Sub4.method423(runtimeexception, "nc.N("
					+ arg0 + ')');
		}
	}
	...
	public Object[] method290(StreamBuffer arg0, byte arg1) {
		try {
			...
			throw Class4_Sub20_Sub7_Sub4.method423(runtimeexception, ("nc.E("
					+ (arg0 != null ? "{...}" : "null") + ',' + arg1 + ')'));
		}
	}
	...
	public void method294(int arg0, int arg1, JagexString arg2) {
		try {
			...
			throw Class4_Sub20_Sub7_Sub4.method423(runtimeexception, ("nc.J("
					+ arg0 + ',' + arg1 + ','
					+ (arg2 != null ? "{...}" : "null") + ')'));
		}
	}
